using Elevador.Aplicacao.Implementacoes;
...
namespace Elevador.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Register services
            container.Register<IElevadorService, ElevadorService>(Lifestyle.Scoped); // lifestyle can set here, sometimes you want to change the default lifestyle like singleton exeptionally
